...
/**
 * Phishing Defender - Main Game Class
 * @author yusef03
 * @version 1.0
 */
public class PhishingDefender extends JFrame {
    ...
    public PhishingDefender() {
        ...
        mainPanel.setBackground(new Color(26, 26, 46)); // Dunkelblau
        ...
        subtitleLabel.setForeground(new Color(255, 107, 53)); // Orange
